...
<div class="chat-container">
    ...
    <div class="user-list" id="userList">
        ...
        <!-- Add if needed <div class="back-btn-container">
            <a href="dashboard.php" class="back-btn no-hover"> <img src="assets/img/arrow-left.png" alt="Back" width="45" height="45px"/></a>
        </div> -->
    </div>
    ...
    <?php if (!isset($recipient)) { ?>
        <img id="image" src="assets/img/smartphone.png" alt="">
    ...
    <?php if (isset($recipient)) { ?>
        <div class="chat-box">
            <h3 class="fixed-header"> <i class="fas fa-user"></i><?php echo htmlspecialchars($recipient['name']); ?></h3>
            <div class="messages">
