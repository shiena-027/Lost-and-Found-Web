...
<body>
    ...
    <ul class="items-list">
        ...
        <li class="item-card">
            <div>
                <p class="status <?php echo htmlspecialchars($item['type']); ?>" id="itemname">
                    <?php echo htmlspecialchars($item['title']); ?>
                </p>

                <p class="status <?php echo strtolower(htmlspecialchars($item['type'])); ?>" id="itemstatus">
                    <i class="fa fa-exclamation-circle"></i>
                    <?php echo htmlspecialchars($item['type']); ?>
                </p>
            </div>

            <p><a href="#" class="zoom-link"><img src="uploads/<?php echo htmlspecialchars($item['image']); ?>"
                        alt="Item Image" class="zoom-image" width="100"></a></p>
            ...
            <p><a href="chat.php?user_id=<?php echo $user['id']; ?>&message=Hi" class="chat-link"><i
                        class="fas fa-comment"></i> Chat</a></p>
